...
public class CalendarFrame extends JFrame implements ActionListener {
	...
	public CalendarFrame() {
		...
		//컴포넌트에 추가 
		c.add(jSpace);
		jSpace.setBounds(70, 30, 100, 30);
		jSpace.setForeground(Color.GRAY);
		
		c.add(jStudio);
		jStudio.setBounds(70, 50, 300, 70);
		jStudio.setFont(new Font("Serif", Font.PLAIN, 20));
		
		ImageIcon thirdImg = new ImageIcon("img04.png");  //"상상파크" 라벨 옆 이미지 
		imgLb4.setIcon(thirdImg);
		imgLb4.setBounds(70, 30, 30, 30);
