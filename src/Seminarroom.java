...
public class Seminarroom extends JFrame {
	...
	public Seminarroom(int width, int height) {
		setTitle("세미나실");
		this.width = width;
		this.height = height;
	...
	public void addLabel() {
		...
		// 방 이름 라벨 - 상단에 위치
				...
				JLabel jStudio = new JLabel("❍  세미나실");
				...
				// 상상관 옆 이미지
				/*
				 * JLabel imgLb3 = new JLabel(); ImageIcon thirdImg = new
				 * ImageIcon("img03.png"); imgLb3.setIcon(thirdImg); imgLb3.setBounds(40, 30,
				 * 40, 40); imgLb3.setHorizontalAlignment(JLabel.CENTER); panel.add(imgLb3);
				 */
